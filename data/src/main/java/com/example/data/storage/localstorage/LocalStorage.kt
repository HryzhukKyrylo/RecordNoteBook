...
interface LocalStorage {
    ...
    fun getUserLogin(userLogName: String): UserLoginDTO?

    fun saveLoginUser(userLogin: UserLoginDTO)
    ...
    fun removeUserAllNotates(userLoginName: String)
    fun removeUserLogin(userLoginName: String): Boolean
}